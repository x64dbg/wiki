...
**You do not have to do all these steps to get started with x64dbg development!** Just go to http://releases.x64dbg.com and extract the dependencies in your build directory.
