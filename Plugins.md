...
- \[[Download](https://github.com/klks/checksec/files/871139/Checksec_v0.1.zip)\][checksec](https://github.com/klks/checksec) by [klks](https://github.com/klks): Plugin checks modules for security features enabled such as SafeSEH/GS/DEP/ASLR/CFG.