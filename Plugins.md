...
- \[[Download](http://pan.baidu.com/s/1jGgL774)\] x64dbg_tol by [lynnux](https://github.com/lynnux): A plugin make string search contains Chinese string(support assic,unicode,utf-8), 使字符串搜索包含中文。And a embeded lua engine, see [luadir](https://github.com/lynnux/luadir)
