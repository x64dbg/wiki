...
- \[[Download](https://github.com/changeofpace/Overwatch-Dump-Fix/releases)\] [Overwatch Dump Fix](https://github.com/changeofpace/Overwatch-Dump-Fix) by [changeofpace](https://github.com/changeofpace): this plugin patches several parts of overwatch.exe in order to produce better process dumps for IDA Pro.
