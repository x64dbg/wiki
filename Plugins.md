...
- \[[Download](http://pan.baidu.com/s/1jGgL774)\] x64dbg_tol by [lynnux](https://github.com/lynnux): 1.Add ESC/` to navigate back/forward, 2.Support drag when runas admin, 3.Make string search contains Chinese(support assic,unicode,utf-8), 4.CTRL+R work like ollydbg, 5.extra command 'bpv', 6.Embeded luajit, see [luadir](https://github.com/lynnux/luadir), 7.Add symbol decoration for gcc and rust.
