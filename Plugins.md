...
- \[[Download](http://pan.baidu.com/s/1jGgL774)\] [x64dbg_tol](https://github.com/lynnux/x64dbg_tol) by [lynnux](https://github.com/lynnux): A plugin make string search contains Chinese string, 使字符串搜索包含中文。
