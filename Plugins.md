...
- \[[Download](https://github.com/changeofpace/Overwatch-Dump-Fix/releases)\] [Overwatch Dump Fix](https://github.com/changeofpace/Overwatch-Dump-Fix) by [changeofpace](https://github.com/changeofpace): This plugin removes anti-dumping and obfuscation techniques from the popular FPS game Overwatch.
