...
- \[[Download](https://github.com/x64dbg/AutoExportPatches/releases)\] [AutoExportPatches](https://github.com/AutoExportPatches/strmatch) by [x64dbg](http://x64dbg.com): Plugin that automatically stores patches in the database and restores them on restart.
